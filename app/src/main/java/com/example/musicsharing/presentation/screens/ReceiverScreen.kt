...
import com.example.musicsharing.presentation.ui.receiver.ReceiverStatus
import com.example.musicsharing.presentation.ui.receiver.ReceiverUiState
...
@Composable
private fun LiveControlsSection(
    onStop: () -> Unit,
    modifier: Modifier = Modifier
) {
    Card(
